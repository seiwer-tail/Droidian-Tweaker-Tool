...
1)    clear
  ...
  3) clear 
   ...
   4) clear
      echo "To set a ringtone please place your melody in flac format in the /home/username/Music directory"
...
2) 
  ...
  3) clear 
   ...
   4) clear
      echo "Для установки звонка пожалуйста поместите вашу мелодию в формате flac в директорию /home/имяпользователя/Music"
